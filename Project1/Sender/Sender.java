 ...
 *   * to generate the Symmetric Key and the Private Key
 *    * 
...
public class Sender {
	...
	public static void main(String[] args) throws Exception{
		/* 
		 * The Files: symmetric.key, XPrivate.key
		...
		*/ 
		...
		// Encrypts message.dd-msg with AES using summetric key
		// and IV vector and produces message.aescipher.
